...
# Build script for cátte — Comfi Hierarchy
...
# Configuration
PACKAGE_NAME="cat.kittyn.comfi-hierarchy"
ROOT_DIR="cat.kittyn.comfi-hierarchy"
REPO_OWNER="kittynXR"
REPO_NAME="comfi-hierarchy"
...
3. Find \"cátte — Comfi Hierarchy\" in the package list and click \"Add\"
"
...
gh release create "$TAG" \
    --title "cátte — Comfi Hierarchy $NEW_VERSION" \
    --notes "$RELEASE_NOTES" \
    $RELEASE_FILES
